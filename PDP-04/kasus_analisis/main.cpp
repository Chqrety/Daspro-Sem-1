...
int main() {
    ...
    // kasus 1 - analisis
    cout << "===== Kasus 1 - Analisis Dua Kasus =====" << endl << endl;
    ...
    // kasus 2
    cout << "===== Kasus 2 =====" << endl << endl;

    cout << "3 < 4          : " << ((3 < 4) ? "True" : "False") << endl;
    cout << "12.5 < 7.5     : " << ((12.5 < 7.5) ? "True" : "False") << endl;
    cout << "5 <= 3.14      : " << ((5 <= 3.14) ? "True" : "False") << endl;
    cout << "3 < false      : " << ((3 < false) ? "True" : "False") << endl;
    cout << "True == False  : " << ((true == false) ? "True" : "False") << endl;
    cout << "True != False  : " << ((true != false) ? "True" : "False") << endl;
    cout << "65 != 'A'      : " << ((65 != 'A') ? "True" : "False") << endl;

    cout << endl << "===================" << endl;

    // kasus 2 - analisis
    cout << "===== Kasus 2 - Analisis Dua Kasus =====" << endl << endl;
    ...
    // kasus 3 - analisis
    cout << "===== Kasus 3 - Analisis Dua Kasus =====" << endl << endl;
